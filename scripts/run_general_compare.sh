...
compare laya laya:convaiinnovations/laya "$LAYA_PY"
compare laya-typed-decisions laya:convaiinnovations/laya-typed-decisions "$LAYA_PY"
echo GENERAL DONE
